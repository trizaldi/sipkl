...
<?php if ($status_verifikasi==1){
?>                      
                      <a class="btn btn-info view_detail" relid="<?php echo $id_usulan; ?>" title="Lihat Kelompok"><i class="fas fa-search-plus"></i></a>
                        <a class="btn btn-success" data-toggle="modal" data-target="#ModalVerifikasi<?php echo $id_usulan;?>" title="Verifikasi Lokasi PKL"><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                        <?php
                      }else {
                        ?>
                        <a class="btn btn-info view_detail" relid="<?php echo $id_usulan; ?>" title="Lihat Kelompok"><i class="fas fa-search-plus"></i></a>
           ...
           <div class="modal fade" id="ModalVerifikasi<?php echo $id_usulan;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url()?>Adminprodi/verifikasi_lokasi/<?php echo $id_usulan ?>" method="post" enctype="multipart/form-data">
                     <div class="modal-body">       
                     <input type="hidden" name="id" value="<?php echo $id_usulan;?>"/> 
                     <p>Apakah Anda akan Memverifikasi ajuan lokasi PKL di <b><?php echo $nama;?></b> ?</p>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('.view_detail').click(function(){
          ...
          console.log(id);
          $.ajax({
              url : "<?php echo base_url(); ?>Adminprodi/find_kelompok_mahasiswa_1",
              data:{id : id},
              method:'POST',
              dataType:'json',
    ...
    $(document).ready(function() {
      ...
      $('.view_detail').click(function(){
          ...
          console.log(id);
          $.ajax({
              url : "<?php echo base_url(); ?>Adminprodi/find_kelompok_mahasiswa_2",
              data:{id : id},
              method:'POST',
              dataType:'json',
              success: function(data){
    ...
    $(document).ready(function() {
      ...
      $('.view_detail').click(function(){
          ...
          console.log(id);
          $.ajax({
              url : "<?php echo base_url(); ?>Adminprodi/find_kelompok_mahasiswa_3",
              data:{id : id},
              method:'POST',
              dataType:'json',
              success: function(data){
    ...
    $(document).ready(function() {
      $('.view_detail').click(function(){
          ...
          console.log(id);
          $.ajax({
              url : "<?php echo base_url(); ?>Adminprodi/find_kelompok_mahasiswa_4",
              data:{id : id},
              method:'POST',
              dataType:'json',
              success: function(data){
    ...
    $(document).ready(function() {
      $('.view_detail').click(function(){
          ...
          console.log(id);
          $.ajax({
              url : "<?php echo base_url(); ?>Adminprodi/find_kelompok_mahasiswa_5",
              data:{id : id},
              method:'POST',
              dataType:'json',
              success: function(data){
