...
?>                      
                      <a class="btn btn-info view_detail" relid="<?php echo $id_usulan; ?>" title="Lihat Kelompok"><i class="fas fa-search-plus"></i></a>
                        <a class="btn btn-danger" data-toggle="modal" data-target="#ModalTolak<?php echo $id_usulan;?>" title="Tolak Lokasi PKL"><i class="fa fa-ban" aria-hidden="true"></i></a>
                        <a class="btn btn-success" data-toggle="modal" data-target="#ModalVerifikasi<?php echo $id_usulan;?>" title="Setujui Lokasi PKL"><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                        <?php
                      }elseif ($status_usulan==2) {
                        ?>
                        <a class="btn btn-info view_detail" relid="<?php echo $id_usulan; ?>" title="Lihat Kelompok"><i class="fas fa-search-plus"></i></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'Korbidpkl/tolak_lokasi'?>/<?php echo $id_usulan ?>" method="post" enctype="multipart/form-data">
                     ...
                     <p>Apakah Anda akan Menolak ajuan lokasi PKL di <b><?php echo $nama;?></b> ?</p>
                               
                    </div>
             
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger btn-flat" id="simpan">Tolak</button>
                    </div>
                    </form>
                </div>
            </div>
