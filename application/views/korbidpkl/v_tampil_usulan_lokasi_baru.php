                  ...
                  <tr>
                    ...
                    <td width="15">
                      ...
                      <div class="btn-group btn-group-sm">
                        ...
                        <a class="btn btn-danger" data-toggle="modal" data-target="#ModalTolak<?php echo $id;?>" title="Tolak Usulan Lokasi Baru"><i class="fa fa-ban" aria-hidden="true"></i></a>
                        <a class="btn btn-success" data-toggle="modal" data-target="#ModalVerifikasi<?php echo $id;?>" title="Setujui Usulan Lokasi Baru"><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                        </td>
                    <?php endforeach;?>
                  </tr>
                  </tbody>
