          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo base_url()?>Admin/tambah_provinsi" target="_parent"><button type='button' class='btn btn-md btn-info '><i class='fa fa-plus' aria-hidden='true'></i> Tambah Provinsi </button></a></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a class="btn btn-danger" data-toggle="modal" data-target="#ModalHapus<?php echo $id;?>"><i class="fa fa-eraser"></i></a>
                    </td>
                    <?php endforeach;?>
                  </tr>
                  </tbody>
