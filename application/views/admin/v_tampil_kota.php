          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo base_url()?>Admin/tambah_kota" target="_parent"><button type='button' class='btn btn-md btn-info '><i class='fa fa-plus' aria-hidden='true'></i> Tambah Kota </button></a></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
