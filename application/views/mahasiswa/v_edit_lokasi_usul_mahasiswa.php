...
<div class="container">
  <form class="form-horizontal" action="<?php echo base_url()?>Mahasiswa/update_usulan_lokasi" method="post" enctype="multipart/form-data">
<div class="form-row">
    <div class="form-group col-md-2">
      <label for="inputZip">Nama lokasi :</label>
      <input type="hidden" name="id" class="form-control"  id="inputZip" readonly value="<?php echo $value->id_lok_usul; ?>">
      <input type="text" name="nama" class="form-control" id="inputZip" required value="<?php echo $value->nama_lok; ?>">
    </div>
  </div>
...
<div class="form-row">
  ...
  <a href="<?php echo base_url()?>Admin/tampil_lokasi" class="btn btn-secondary">Kembali</a>
