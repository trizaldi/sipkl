...
<div class="container">
  <form class="form-horizontal" action="<?php echo base_url()?>Mahasiswa/insert_lokasi" method="post" enctype="multipart/form-data">
<div class="form-row">
...
<div class="form-row">
  ...
  <a href="<?php echo base_url()?>Mahasiswa/tampil_lokasi" class="btn btn-secondary">Kembali</a>
